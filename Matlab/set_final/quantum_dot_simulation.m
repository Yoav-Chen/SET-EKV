...
mode =2;   % @1 original data @ 2 sub EKV
if mode == 1
...
x = exp(-delta_FS_i_sub/(kB*temp))
y = exp(qc*Vds/(kB*temp))
xy=x*y
...
(1*(1+x)*(1+1/(x*y))-1*(1+1/x)*(1+x*y))/(1*(1+x)*(1+1/(x*y))*(1+x*y)+1*(1+1/x)*(1+1/(x*y))*(1+x*y)+1*(1+x)*(1+1/x)*(1+x*y)+1*(1+x)*(1+1/x)*(1+1/(x*y)))




(1-exp(qc*Vds/(kB*temp)))./(1 +  exp(delta_FS_i_sub/(kB*temp))...
                                           +exp(-delta_FD_i_sub/(kB*temp))...
                                           +exp(qc*Vds/(kB*temp)))
